...
category.name.toLowerCase().includes(searchTerm.toLowerCase())
    ...
    const deleteByCategoryId= async (categoryId) => {
        try{
          ...
          console.error(error);//display error toast message
          toast.error("Unable to delete category");
        }
    }
    return (
        <div className="category-list-container" style={{heigh:'100vh', overflowY:'auto', overflowX:'hidden'}}>
